...
export const LoginPage: React.FC<Props> = ({ onLoggedIn }) => {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-ktsDarkBlue via-ktsBlue to-slate-900 px-4 py-6 sm:py-8">
			<div className="w-full max-w-md bg-slate-900/80 border border-ktsBlue/60 rounded-2xl shadow-2xl px-5 py-6 sm:px-8 sm:py-8 space-y-6">
				<div className="flex flex-col items-center gap-3 text-center">
					...
					/>
					<h1 className="mt-1 text-lg sm:text-xl font-semibold text-white">Weboldal monitorozó belépés</h1>
				...
				<form onSubmit={handleSubmit} className="space-y-4 mt-4">
					<div className="space-y-1">
						<label className="block text-xs sm:text-sm font-medium text-slate-200" htmlFor="email">
							E-mail cím
						</label>
						<input
							id="email"
					...
					<div className="space-y-1">
						<label className="block text-xs sm:text-sm font-medium text-slate-200" htmlFor="password">
							Jelszó
						</label>
						<input
							id="password"
